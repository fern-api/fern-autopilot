...
export async function createGithubWorkflowRun(
  client: Client,
  args: CreateGithubWorkflowRunArgs
): Promise<CreateGithubWorkflowRunRow | null> {
...
export async function getGithubWorkflowRun(
  client: Client,
  args: GetGithubWorkflowRunArgs
): Promise<GetGithubWorkflowRunRow | null> {
  const result = await client.query({
...
export async function getGithubWorkflowRunByWorkflowRunId(
  client: Client,
  args: GetGithubWorkflowRunByWorkflowRunIdArgs
): Promise<GetGithubWorkflowRunByWorkflowRunIdRow | null> {
  const result = await client.query({
...
export async function listGithubWorkflowRunsByGeneratorRun(
  client: Client,
  args: ListGithubWorkflowRunsByGeneratorRunArgs
): Promise<ListGithubWorkflowRunsByGeneratorRunRow[]> {
  const result = await client.query({
...
export async function listGithubWorkflowRunsByRepo(
  client: Client,
  args: ListGithubWorkflowRunsByRepoArgs
): Promise<ListGithubWorkflowRunsByRepoRow[]> {
  const result = await client.query({
...
export async function listGithubWorkflowRunsByStatus(
  client: Client,
  args: ListGithubWorkflowRunsByStatusArgs
): Promise<ListGithubWorkflowRunsByStatusRow[]> {
  const result = await client.query({
...
export async function listRecentGithubWorkflowRuns(
  client: Client,
  args: ListRecentGithubWorkflowRunsArgs
): Promise<ListRecentGithubWorkflowRunsRow[]> {
  const result = await client.query({
...
export async function updateGithubWorkflowRunStatus(
  client: Client,
  args: UpdateGithubWorkflowRunStatusArgs
): Promise<UpdateGithubWorkflowRunStatusRow | null> {
  const result = await client.query({
...
export async function updateGithubWorkflowRunStatusByWorkflowRunId(
  client: Client,
  args: UpdateGithubWorkflowRunStatusByWorkflowRunIdArgs
): Promise<UpdateGithubWorkflowRunStatusByWorkflowRunIdRow | null> {
  const result = await client.query({
