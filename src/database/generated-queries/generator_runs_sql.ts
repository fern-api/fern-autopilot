...
export async function createGeneratorRun(client: Client, args: CreateGeneratorRunArgs): Promise<CreateGeneratorRunRow | null> {
    const result = await client.query({
        text: createGeneratorRunQuery,
        values: [args.orgConfigRepoId, args.generatorName, args.generatorVersion, args.status, args.triggerType, args.commitSha],
        rowMode: "array"
    });
...
export async function listGeneratorRunsByConfigRepo(client: Client, args: ListGeneratorRunsByConfigRepoArgs): Promise<ListGeneratorRunsByConfigRepoRow[]> {
    const result = await client.query({
...
export async function listGeneratorRunsByStatus(client: Client, args: ListGeneratorRunsByStatusArgs): Promise<ListGeneratorRunsByStatusRow[]> {
    const result = await client.query({
...
export async function listRecentGeneratorRuns(client: Client, args: ListRecentGeneratorRunsArgs): Promise<ListRecentGeneratorRunsRow[]> {
    const result = await client.query({
...
export async function updateGeneratorRunStatus(client: Client, args: UpdateGeneratorRunStatusArgs): Promise<UpdateGeneratorRunStatusRow | null> {
    const result = await client.query({
...
export async function startGeneratorRun(client: Client, args: StartGeneratorRunArgs): Promise<StartGeneratorRunRow | null> {
    const result = await client.query({
...
export async function completeGeneratorRun(client: Client, args: CompleteGeneratorRunArgs): Promise<CompleteGeneratorRunRow | null> {
    const result = await client.query({
