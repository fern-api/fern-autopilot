...
export async function createCustomerOrg(client: Client, args: CreateCustomerOrgArgs): Promise<CreateCustomerOrgRow | null> {
...
export async function getCustomerOrgByName(client: Client, args: GetCustomerOrgByNameArgs): Promise<GetCustomerOrgByNameRow | null> {
    const result = await client.query({
...
export async function getCustomerOrgByGithubOrg(client: Client, args: GetCustomerOrgByGithubOrgArgs): Promise<GetCustomerOrgByGithubOrgRow | null> {
    const result = await client.query({
...
export async function updateCustomerOrg(client: Client, args: UpdateCustomerOrgArgs): Promise<UpdateCustomerOrgRow | null> {
    const result = await client.query({
