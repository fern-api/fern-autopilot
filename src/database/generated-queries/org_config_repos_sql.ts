...
export async function createOrgConfigRepo(client: Client, args: CreateOrgConfigRepoArgs): Promise<CreateOrgConfigRepoRow | null> {
...
export async function getOrgConfigRepo(client: Client, args: GetOrgConfigRepoArgs): Promise<GetOrgConfigRepoRow | null> {
    const result = await client.query({
...
export async function getOrgConfigRepoByCustomerOrgAndName(client: Client, args: GetOrgConfigRepoByCustomerOrgAndNameArgs): Promise<GetOrgConfigRepoByCustomerOrgAndNameRow | null> {
    const result = await client.query({
...
export async function listOrgConfigReposByCustomerOrg(client: Client, args: ListOrgConfigReposByCustomerOrgArgs): Promise<ListOrgConfigReposByCustomerOrgRow[]> {
    const result = await client.query({
...
export async function updateOrgConfigRepo(client: Client, args: UpdateOrgConfigRepoArgs): Promise<UpdateOrgConfigRepoRow | null> {
    const result = await client.query({
